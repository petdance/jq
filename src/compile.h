...
block gen_noop();
FNCONST int block_is_noop(block b);
block gen_op_simple(opcode op);
block gen_const(jv constant);
block gen_const_global(jv constant, const char *name);
FNPURE int block_is_const(block b);
FNPURE int block_is_const_inf(block b);
FNPURE jv_kind block_const_kind(block b);
...
FNPURE int block_has_main(block);
FNPURE int block_is_funcdef(block b);
FNCONST int block_is_single(block b);
